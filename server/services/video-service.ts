    ...
    */
    ...
    public async GetGridViewData() {
        ...
        let results = iframes.map(async (_: any, i: any) => {
            ...
            const url = `http://localhost:3080/api/videos/${this.videoName}/group-of-pictures/${i}`;
    ...
    /**
     * get the reqused Group from fraime index
     * @param index 
     * @param writeStream 
     */
    public async GetFrameViewDataByIndex(index: number, writeStream: Response) {
        // get the range fron I frame to the next one
